...
<!--    <link rel="stylesheet" href="https://megaone.acrothemes.com/vendor/css/cubeportfolio.min.css">-->
    <link rel="stylesheet" href="stylesheet/cubeportfolio.min.css">
...
<!--    <link rel="stylesheet" href="stylesheet/jquery.fancybox.min.css">-->
    <link rel="stylesheet" href="stylesheet/line-awesome.min.css">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Noticia+Text:ital,wght@0,700;1,400&display=swap" rel="stylesheet"><!--    <link rel="stylesheet" href="https://megaone.acrothemes.com/charity/css/style.css">-->
...
<!--                            <a href="#">-->
<!--                                <img src="https://megaone.acrothemes.com/charity/img/logo-white.png" alt="LOGO IMAGE"></a>-->
<!--                        </div>-->
<!--                </div>-->
...
<!--    </div>-->
    ...
    <nav id="my-nav1" class="navbar navbar-expand-sm navbar-light rounded-bar transparent-bar margin-nav">
        <div class="container bg-trans-color">
            <div class="logo">
                <a href="#home" class="scroll"><img src="images/logo.png" alt="Logo Img"></a>
            </div>
            <div class="collapse navbar-collapse" id="navbarSupportedContent1" >
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#causes">CAUSE</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="outer-window">
        <div class="navbar_small">
            ...
            <div class="logo">
                <a href="#home" class="scroll"><img src="https://megaone.acrothemes.com/charity/img/logo-white.png" alt="Logo Img"></a>
            </div>
        <nav class="navbar1">
            <ul class="navbar-nav">
        ...
        <div id="rev_slider_2_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.8.1">
            <ul>	<!-- SLIDE  -->
                <li data-index="rs-4" data-transition="crossfade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb=" "  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="images/01.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 6; white-space: nowrap; font-size: 24px; line-height: 34px; font-weight: 300; color: #ffffff; letter-spacing: 0;font-family:'Noticia Text', sans-serif;">BANKOLE FOUNDATION</div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 7; white-space: nowrap; font-size: 100px;
                          line-height: 85px; font-weight: 700; color: #ffffff;
                          letter-spacing: 0;font-family: 'Noticia Text', serif;">
                        PAUL & KHANITTHA
                    </div>
                </li>
                <!-- SLIDE  -->
                <li data-index="rs-6" data-transition="crossfade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb=" "  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="images/skill.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    <div class="layer-overlay"></div>
                    <!-- LAYER NR. 4 -->
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 6; white-space: nowrap; font-size: 24px; line-height: 34px; font-weight: 300; color: #ffffff; letter-spacing: 0;font-family:'Noticia Text', sans-serif;"> Lending hands to the youths </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 7; white-space: nowrap; font-size: 100px;
                          line-height: 85px; font-weight: 700; color: #ffffff;
                          letter-spacing: 0;font-family: 'Noticia Text', serif;"> SKILL AQUISITION </div>
                    ...
                    <div class="tp-caption rev-btn"
                         ...
                         style="z-index: 11; white-space: nowrap; font-size: 15px; line-height: 17px; font-weight: 300; color: #ffffff; letter-spacing: 0;font-family:'Raleway', sans-serif;"><a href="#about" class="btn btn-slider black-btn mr-2"> Read More</a>
                    </div>
                </li>
                <!-- SLIDE  -->
                <li data-index="rs-8" data-transition="crossfade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb=" "  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="images/empower.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    <div class="layer-overlay"></div>
                    <!-- LAYER NR. 7 -->
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 6; white-space: nowrap; font-size: 24px; line-height: 34px; font-weight: 300; color: #ffffff; letter-spacing: 0;font-family:'Noticia Text', sans-serif;">Giving power to the leaders of tomorrow</div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 7; white-space: nowrap; font-size: 100px;
                          line-height: 85px; font-weight: 700; color: #ffffff;
                          letter-spacing: 0;font-family: 'Noticia Text', serif;"> YOUTH EMPOWERMENT </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="about-img">
                    <img src="https://megaone.acrothemes.com/charity/img/about.jpg" alt="ABOUT MAGE">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row no-gutters cast-card">
                    <div class="col-12">
                        <div class="causes-img">
                            <img src="images/music%20production.jpg" alt="image">
                        </div>
...
<!--                                    </div>-->
<!--                                </div>-->
                                <h3 class="causes-name text-yellow">Music production</h3>
                                ...
                                <a href="#contact" class="btn btn-slider black-btn small-btn"> Register </a>
                            </div>
...
<!--                                    </div>-->
<!--                                </div>-->
                                <h3 class="causes-name text-yellow">Photo & Video editing</h3>
                                <p class="sub-heading height-sub-heading mb-3">Lorem ipsum dolor sit amet conset sed tem sit amet, conset sed tem dolor sit amet.</p>
                                <a href="#contact" class="btn btn-slider black-btn small-btn"> Register </a>
                            </div>
                            <div class="overlay-causes"></div>
                        ...
                        <div class="causes-img">
                            <img src="images/media%20editing.jpg" alt="image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="item">
                <div class="row no-gutters cast-card">
                    <div class="col-12">
                        <div class="causes-img">
                            <img src="images/2d3d.jpg" alt="image">
                        </div>
                        <div class="causes-detail d-flex align-items-center">
                            <div class="causes-content">
<!--                                <div class="skill-tab mb-3">-->
...
<!--                                    </div>-->
<!--                                </div>-->
                                <h3 class="causes-name text-yellow">2D & 3D Animation</h3>
                                <p class="sub-heading height-sub-heading mb-3">Lorem ipsum dolor sit amet conset sed tem sit amet, conset sed tem dolor sit amet.</p>
                                <a href="#contact" class="btn btn-slider black-btn small-btn">Register</a>
                            </div>
                            <div class="overlay-causes"></div>
...
<!--                                    </div>-->
<!--                                </div>-->
                                <h3 class="causes-name text-yellow"> Voice Training and Lyrics writing</h3>
                                <p class="sub-heading height-sub-heading mb-3">Lorem ipsum dolor sit amet conset sed tem sit amet, conset sed tem dolor sit amet.</p>
                                <a href="#contact" class="btn btn-slider black-btn small-btn"> Register </a>
                            </div>
                            <div class="overlay-causes"></div>
                        ...
                        <div class="causes-img">
                            <img src="images/vt.jpg" alt="image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="item">
                <div class="row no-gutters cast-card">
                    <div class="col-12">
                        <div class="causes-img">
                            <img src="images/strategy.jpg" alt="image">
                        </div>
                        <div class="causes-detail d-flex align-items-center">
                            <div class="causes-content">
                                <!--                                <div class="skill-tab mb-3">-->
                                ...
                                <!--                                    </div>-->
                                <!--                                </div>-->
                                <h3 class="causes-name text-yellow"> Digital Marketing</h3>
                                <p class="sub-heading height-sub-heading mb-3">Lorem ipsum dolor sit amet conset sed tem sit amet, conset sed tem dolor sit amet.</p>
                                <a href="#contact" class="btn btn-slider black-btn small-btn"> Register </a>
                            </div>
                            <div class="overlay-causes"></div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="causes-detail d-flex align-items-center">
                            <div class="causes-content">
                                ...
                                <!--                                    </div>-->
                                <!--                                </div>-->
                                <h3 class="causes-name text-yellow"> Graphics design </h3>
                                <p class="sub-heading height-sub-heading mb-3">Lorem ipsum dolor sit amet conset sed tem sit amet, conset sed tem dolor sit amet.</p>
                                <a href="#contact" class="btn btn-slider black-btn small-btn"> Register </a>
                            </div>
                            <div class="overlay-causes"></div>
...
<!--                            <div class="image">-->
<!--                                <img src="https://megaone.acrothemes.com/charity/img/donate1.jpg" alt="">-->
<!--                            </div>-->
...
<!--                            <div class="image">-->
<!--                                <img src="https://megaone.acrothemes.com/charity/img/donate2.jpg" alt="">-->
<!--                            </div>-->
<!--                            <div class="team-content">-->
...
<!--                            <div class="image">-->
<!--                                <img src="https://megaone.acrothemes.com/charity/img/donate3.jpg" alt="">-->
<!--                            </div>-->
<!--                            <div class="team-content">-->
...
<!--                            <div class="image">-->
<!--                                <img src="https://megaone.acrothemes.com/charity/img/donate4.jpg" alt="">-->
<!--                            </div>-->
<!--                            <div class="team-content">-->
    ...
    <div class="container">
        ...
        <div id="js-grid-mosaic" class="cbp cbp-l-grid-mosaic">
            ...
            <div class="cbp-item height2">
                <a href="https://megaone.acrothemes.com/charity/img/portfolio1.jpg"  data-fancybox="gallery1">
            ...
            <div class="cbp-item height2">
                <a href="https://megaone.acrothemes.com/charity/img/portfolio2.jpg"  data-fancybox="gallery1">
            ...
            <div class="cbp-item">
                <a href="https://megaone.acrothemes.com/charity/img/portfolio4.jpg"  data-fancybox="gallery1">
            ...
            <div class="cbp-item height1">
                <a href="https://megaone.acrothemes.com/charity/img/portfolio3.jpg"  data-fancybox="gallery1">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 d-flex align-items-center  order-2 order-md-1 mt-4 mt-md-0">
                <div class="contact-box">
                    ...
                    <div class="sub-heading text-center text-md-left text-black">
                        ...
                        <!--Address-->
                        <p class="mb-3">724 Babatunde Atere St, Omole Phase 2, Ikeja. </p>

                        <!--Phone-->
                        <p class="mb-3"> Office Telephone : +234 817456790 <br>
                            Mobile : +234 817456790 </p>

                        <!--Email-->
                        <p class="mb-3"> Email: <a href="mailto:avalanche2u@gmail.com" class="color-black">avalanche2u@gmail.com </a> <br>
                            Inquiries: <a href="mailto:avalanche2u@gmail.com" class="color-black">avalanche2u@gmail.com </a> </p>
...
<!--                            <iframe class="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3333.9674103770367!2d-111.89998968532109!3d33.31966746342612!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzPCsDE5JzEwLjgiTiAxMTHCsDUzJzUyLjEiVw!5e0!3m2!1sen!2s!4v1573716071790!5m2!1sen!2s" width="600" height="450" style="border:0;" allowfullscreen=""></iframe>-->
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.132902492268!2d3.3707462149479235!3d6.630410723750314!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b93a276bdb9b7%3A0x8bec83a20da17327!2sPhase%202%2C%20724%20Babatunde%20Atere%20St%2C%20Olowora%2C%20Lagos!5e0!3m2!1sen!2sng!4v1607169331820!5m2!1sen!2sng" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                        </div>
                    </div>
            </div>
        </div>
